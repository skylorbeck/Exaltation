    ...
    public void onUse() {
        if (entity.isSneaking()) {
            ...
            if (statusEffectInstances.length>1) {
                ((PlayerEntity) entity).sendMessage(new TranslatableText("exaltation.quiver_swap"), true);
            } else {
                ((PlayerEntity) entity).sendMessage(new TranslatableText("exaltation.disabled"), true);
            }
