...
public class ExaltationFollowOwnerGoal extends Goal {
	...
	public ExaltationFollowOwnerGoal(MobEntity pet, LivingEntity owner, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {
